...
class NamespacesApi(object):
    ...
    def set_namespace_for_prefix_with_http_info(self, repository_id, namespaces_prefix, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def get_namespaces(self, repository_id, **kwargs):  # noqa: E501
        """Get namespace for a particular prefix  # noqa: E501

        Gets the namespace that has been defined for a particular prefix.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_namespace_for_prefix(repository_id,  async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_namespaces_with_http_info(repository_id,  **kwargs)  # noqa: E501
        else:
            (data) = self.get_namespaces_with_http_info(repository_id, **kwargs)  # noqa: E501
            return data

    def get_namespaces_with_http_info(self, repository_id,  **kwargs):  # noqa: E501
        """Get namespace for a particular prefix  # noqa: E501

        Gets the namespace that has been defined for a particular prefix.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_namespace_for_prefix_with_http_info(repository_id,  async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/repositories/{repositoryID}/namespaces', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
